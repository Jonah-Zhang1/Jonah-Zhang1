...
*
*   @addtogroup emios_icu_ip_trustedfunctions EMIOS IPL
*   @{
*/
...
#define EMIOS_ICU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION            4
#define EMIOS_ICU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION         0
#define EMIOS_ICU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION                    2
