...
#define WKPU_IP_TYPES_AR_RELEASE_MINOR_VERSION      4
#define WKPU_IP_TYPES_AR_RELEASE_REVISION_VERSION   0
#define WKPU_IP_TYPES_SW_MAJOR_VERSION              2
...
==================================================================================================*/
    ...
    /* Check if header file and StandardTypes.h file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Wkpu_Ip_Types.h and StandardTypes.h are different"
    #endif
#endif
