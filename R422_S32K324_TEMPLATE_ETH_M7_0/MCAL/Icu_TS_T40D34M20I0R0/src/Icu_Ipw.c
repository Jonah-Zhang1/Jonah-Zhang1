...
void Icu_Ipw_SetSleepMode(const Icu_Ipw_ChannelConfigType* ChannelConfig)
{
    ...
    switch(ipType)
    {
        case ICU_EMIOS_MODULE:
            {
                channel = (ChannelConfig->pEmiosHwChannelConfig)->hwChannel;
                Emios_Icu_Ip_SetSleepMode(module, channel);
            }
            break;
        case ICU_SIUL2_MODULE:
            {
...
void Icu_Ipw_SetNormalMode (const Icu_Ipw_ChannelConfigType* ChannelConfig)
{
    ...
    switch(ipType)
    {
        case ICU_EMIOS_MODULE:
            {
                channel = (ChannelConfig->pEmiosHwChannelConfig)->hwChannel;
                Emios_Icu_Ip_SetNormalMode(module, channel);
            }
            break;
        case ICU_SIUL2_MODULE:
            {
        ...
        case ICU_EMIOS_MODULE:
            {
                ...
                {
                    Emios_Icu_Ip_SetActivation(module, channel, EMIOS_ICU_FALLING_EDGE);
                }
                else if (ICU_RISING_EDGE == activation)
                {
                    Emios_Icu_Ip_SetActivation(module, channel, EMIOS_ICU_RISING_EDGE);
                }
                else if (ICU_BOTH_EDGES == activation)
                {
                    Emios_Icu_Ip_SetActivation(module, channel, EMIOS_ICU_BOTH_EDGES);
                }
                else
                {
                    Emios_Icu_Ip_SetActivation(module, channel, EMIOS_ICU_NO_PIN_CONTROL);
                }
            }
            break;
        case ICU_SIUL2_MODULE:
...
boolean Icu_Ipw_GetInputState(const Icu_Ipw_ChannelConfigType *ChannelConfig)
{
    ...
    else if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
...
{
    /*If the module is emios then starting timestamp*/
    if (ICU_EMIOS_MODULE == channelConfig->channelIp)
    {
...
{
    /*stop timestamp if module is emios*/
    if (ICU_EMIOS_MODULE == channelConfig->channelIp)
    {
...
{
    uint32 startAddr = 0U;
    /*get the base address if module is emios*/
    if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
...
{
    /*If the module is Emios, reset counting edges*/
    if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
...
{
    /*Enable counting if the module is Emios*/
    if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
...
uint16 Icu_Ipw_GetEdgeNumbers(const Icu_Ipw_ChannelConfigType *ChannelConfig)
{
    ...
    /*Get a number of edges if the module is Emios*/
    if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
        edgeNumber = (uint16)Emios_Icu_Ip_GetEdgeNumbers(ChannelConfig->instanceNo, \
                               (ChannelConfig->pEmiosHwChannelConfig)->hwChannel);
    }
    else
    {
...
void Icu_Ipw_EnableEdgeDetection(const Icu_Ipw_ChannelConfigType * ChannelConfig)
{
    ...
    switch(ipType)
    {
        case ICU_EMIOS_MODULE:
            {
                channel = (ChannelConfig->pEmiosHwChannelConfig)->hwChannel;
                Emios_Icu_Ip_EnableEdgeDetection(module, channel);
            }
            break;
        case ICU_SIUL2_MODULE:
            {
...
void Icu_Ipw_DisableEdgeDetection(const Icu_Ipw_ChannelConfigType* ChannelConfig)
{
    ...
    switch(ipType)
    {
        case ICU_EMIOS_MODULE:
            {
                channel = (ChannelConfig->pEmiosHwChannelConfig)->hwChannel;
                Emios_Icu_Ip_DisableEdgeDetection(module, channel);
            }
            break;
        case ICU_SIUL2_MODULE:
            {
                channel = (ChannelConfig->pSiul2HwChannelConfig)->hwChannel;
                Siul2_Icu_Ip_DisableInterrupt(module, channel);
            }
            break;
        case ICU_WKPU_MODULE:
            {
                channel = (ChannelConfig->pWkpuHwChannelConfig)->hwChannel;
                Wkpu_Ip_DisableInterrupt(module, channel);
            }
            break;
        case ICU_CMP_MODULE:
            {
...
Icu_LevelType Icu_Ipw_GetInputLevel(const Icu_Ipw_ChannelConfigType* ChannelConfig)
{
    ...
    /*get the input level of module Emios*/
    if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
...
Std_ReturnType Icu_Ipw_ValidateSignalMeasureWithoutInterrupt(const Icu_Ipw_ChannelConfigType * ChannelConfig)
{
    ...
    /*get the value of ICU signal while not using IRQ*/
    if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
...
{
    /*get pulse width if module is emios*/
    if (ICU_EMIOS_MODULE == ChannelConfig->channelIp)
    {
...
void Icu_Ipw_EnableNotification(const Icu_Ipw_ChannelConfigType* ChannelConfig)
{
    ...
    switch(ipType)
    {
        ...
        {
            channel = (ChannelConfig->pEmiosHwChannelConfig)->hwChannel;
            Emios_Icu_Ip_EnableNotification(module, channel);
            break;
        }
        default:
        {
...
void Icu_Ipw_DisableNotification(const Icu_Ipw_ChannelConfigType* ChannelConfig)
{
    ...
    switch(ipType)
    {
        ...
        {
            channel = (ChannelConfig->pEmiosHwChannelConfig)->hwChannel;
            Emios_Icu_Ip_DisableNotification(module, channel);
            break;
        }
        default:
        {
