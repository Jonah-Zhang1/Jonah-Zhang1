...
/* Check if current file and Flexio_I2c_Ip header file are of the same vendor */
#if (I2C_IPW_VENDOR_ID_C != FLEXIO_I2C_IP_VENDOR_ID)
    #error "Flexio_I2c_Ip.h and I2c_Ipw.c have different vendor ids"
#endif
/* Check if current file and Flexio_I2c_Ip header file are of the same Autosar version */
#if ((I2C_IPW_AR_RELEASE_MAJOR_VERSION_C != FLEXIO_I2C_IP_AR_RELEASE_MAJOR_VERSION) || \
     (I2C_IPW_AR_RELEASE_MINOR_VERSION_C != FLEXIO_I2C_IP_AR_RELEASE_MINOR_VERSION) || \
     (I2C_IPW_AR_RELEASE_REVISION_VERSION_C != FLEXIO_I2C_IP_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Flexio_I2c_Ip.h and I2c_Ipw.c are different"
#endif
/* Check if current file and Flexio_I2c_Ip header file are of the same Software version */
#if ((I2C_IPW_SW_MAJOR_VERSION_C != FLEXIO_I2C_IP_SW_MAJOR_VERSION) || \
     (I2C_IPW_SW_MINOR_VERSION_C != FLEXIO_I2C_IP_SW_MINOR_VERSION) || \
     (I2C_IPW_SW_PATCH_VERSION_C != FLEXIO_I2C_IP_SW_PATCH_VERSION) \
    )
 #error "Software Version Numbers of Flexio_I2c_Ip.h and I2c_Ipw.c are different"
#endif
#endif

/* Check if current file and Lpi2c_Ip header file are of the same vendor */
#if (I2C_IPW_VENDOR_ID_C != LPI2C_IP_VENDOR_ID)
    #error "Lpi2c_Ip.h and I2c_Ipw.c have different vendor ids"
#endif
/* Check if current file and Lpi2c_Ip header file are of the same Autosar version */
#if ((I2C_IPW_AR_RELEASE_MAJOR_VERSION_C != LPI2C_IP_AR_RELEASE_MAJOR_VERSION) || \
     (I2C_IPW_AR_RELEASE_MINOR_VERSION_C != LPI2C_IP_AR_RELEASE_MINOR_VERSION) || \
     (I2C_IPW_AR_RELEASE_REVISION_VERSION_C != LPI2C_IP_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Lpi2c.h and I2c_Ipw.c are different"
#endif
/* Check if current file and Lpi2c_Ip header file are of the same Software version */
#if ((I2C_IPW_SW_MAJOR_VERSION_C != LPI2C_IP_SW_MAJOR_VERSION) || \
     (I2C_IPW_SW_MINOR_VERSION_C != LPI2C_IP_SW_MINOR_VERSION) || \
     (I2C_IPW_SW_PATCH_VERSION_C != LPI2C_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Lpi2c_Ip.h and I2c_Ipw.c are different"
#endif
...
{
    Std_ReturnType TmpReturn = (Std_ReturnType)E_NOT_OK;
