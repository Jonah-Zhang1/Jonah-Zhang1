...
#define EMIOS_OCU_IP_AR_RELEASE_MINOR_VERSION        4
#define EMIOS_OCU_IP_AR_RELEASE_REVISION_VERSION     0
#define EMIOS_OCU_IP_SW_MAJOR_VERSION                2
...
/**
* @brief        Get eMIOS Instance number from hardcoded channel Id
*
* @param[in]    HwChannelId - eMios hardcoded channel Id
* return        eMIOS Instance number
*/
static inline uint8 Emios_Ocu_Ip_GetInstanceNum(uint16 HwChannelId)
{
    return (uint8)((HwChannelId & EMIOS_MOD_MASK) >> EMIOS_MOD_SHIFT);
}

/**
* @brief        Get eMIOS Channel number from hardcoded channel Id
*
* @param[in]    HwChannelId - eMios hardcoded channel Id
* return        Channel number in the eMIOS instance
*/
static inline uint8 Emios_Ocu_Ip_GetChannelNum(uint16 HwChannelId)
{
    return (uint8)((HwChannelId & EMIOS_CH_MASK) >> EMIOS_CH_SHIFT);
}
