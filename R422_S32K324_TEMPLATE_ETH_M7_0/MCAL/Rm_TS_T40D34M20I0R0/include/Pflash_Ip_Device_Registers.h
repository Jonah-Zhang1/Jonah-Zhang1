...
#define RM_PFLASH_IP_DEVICE_REGISTERS_AR_RELEASE_MINOR_VERSION       4
#define RM_PFLASH_IP_DEVICE_REGISTERS_AR_RELEASE_REVISION_VERSION    0
#define RM_PFLASH_IP_DEVICE_REGISTERS_SW_MAJOR_VERSION               2
...
#define PFLASH_IP_PFARP_ADDR32                 ((uint32)((uint32)IP_PFLASH_BASE + (uint32)PFLASH_IP_PFAPR_OFFSET))
