...
#define RM_AXBS_IP_DEVICE_REGISTERS_AR_RELEASE_MINOR_VERSION       4
#define RM_AXBS_IP_DEVICE_REGISTERS_AR_RELEASE_REVISION_VERSION    0
#define RM_AXBS_IP_DEVICE_REGISTERS_SW_MAJOR_VERSION               2
...
#define AXBS_BASE_ADDR32(instance)        ((uint32)IP_AXBS_LITE_BASE + ((uint32)(instance) * ((uint32)(0x0U))))
/*  AXBS_PRS register */
