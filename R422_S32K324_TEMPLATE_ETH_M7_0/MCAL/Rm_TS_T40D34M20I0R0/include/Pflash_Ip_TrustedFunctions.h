...
#define RM_PFLASH_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION     4
#define RM_PFLASH_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION  0
#define RM_PFLASH_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION             2
 ...
 *
 */
extern void Pflash_Ip_SetAccessProtection_Privileged(uint8 u8instance,Pflash_Ip_MasterType eMaster, Pflash_Ip_MasterAccessType eAccess);
