...
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_AR_RELEASE_MINOR_VERSION       4
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_AR_RELEASE_REVISION_VERSION    0
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_SW_MAJOR_VERSION               2
...
#define VIRT_WRAPPER_IP_PAD_MASK                          (3UL)
