...
#define RM_VIRT_WRAPPER_IP_AR_RELEASE_MINOR_VERSION       4
#define RM_VIRT_WRAPPER_IP_AR_RELEASE_REVISION_VERSION    0
#define RM_VIRT_WRAPPER_IP_SW_MAJOR_VERSION               2
...
#if (RM_VIRT_WRAPPER_IP_VENDOR_ID != RM_VIRT_WRAPPER_IP_TYPES_VENDOR_ID)
    #error "Virt_Wrapper_Ip.h and Virt_Wrapper_Ip_Types.h have different vendor ids"
#endif
#if ((RM_VIRT_WRAPPER_IP_AR_RELEASE_MAJOR_VERSION    != RM_VIRT_WRAPPER_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_AR_RELEASE_MINOR_VERSION    != RM_VIRT_WRAPPER_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_AR_RELEASE_REVISION_VERSION != RM_VIRT_WRAPPER_IP_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Virt_Wrapper_Ip.h and Virt_Wrapper_Ip_Types.h are different"
#endif
#if ((RM_VIRT_WRAPPER_IP_SW_MAJOR_VERSION != RM_VIRT_WRAPPER_IP_TYPES_SW_MAJOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_SW_MINOR_VERSION != RM_VIRT_WRAPPER_IP_TYPES_SW_MINOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_SW_PATCH_VERSION != RM_VIRT_WRAPPER_IP_TYPES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Virt_Wrapper_Ip.h and Virt_Wrapper_Ip_Types.h are different"
#endif
...
#if (RM_VIRT_WRAPPER_IP_VENDOR_ID != RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_VENDOR_ID)
    #error "Virt_Wrapper_Ip.h and Virt_Wrapper_Ip_Device_Registers.h have different vendor ids"
#endif
#if ((RM_VIRT_WRAPPER_IP_AR_RELEASE_MAJOR_VERSION    != RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_AR_RELEASE_MAJOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_AR_RELEASE_MINOR_VERSION    != RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_AR_RELEASE_MINOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_AR_RELEASE_REVISION_VERSION != RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Virt_Wrapper_Ip.h and Virt_Wrapper_Ip_Device_Registers.h are different"
#endif
#if ((RM_VIRT_WRAPPER_IP_SW_MAJOR_VERSION != RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_SW_MAJOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_SW_MINOR_VERSION != RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_SW_MINOR_VERSION) || \
     (RM_VIRT_WRAPPER_IP_SW_PATCH_VERSION != RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Virt_Wrapper_Ip.h and Virt_Wrapper_Ip_Device_Registers.h are different"
#endif
