...
#define RM_AXBS_IP_TYPES_AR_RELEASE_MINOR_VERSION         4
#define RM_AXBS_IP_TYPES_AR_RELEASE_REVISION_VERSION      0
#define RM_AXBS_IP_TYPES_SW_MAJOR_VERSION                 2
...
typedef struct
{
    const Axbs_Ip_PortNumberType         Axbs_PortNumber;          /*!< hardware port number */
...
typedef struct
{
    const Axbs_Ip_CrossbarPortType       AxbsCrossbarIpNumPorts;   /*!< The number of configured channels. **/
