...
#define RM_XRDC_IP_DEVICE_REGISTERS_SW_MAJOR_VERSION               2
...
#define XRDC_REG_READ8(address)                          (*(volatile uint8*)(address))
...
#define XRDC_MDA_W_DFMT1_ADDR32(instance, idx0)                   ((uint32)(XRDC_MOD_BASEADDR_ADDR32(instance) + (uint32)XRDC_MDA_W_DFMT0_OFFSET + (uint32)(((uint32)idx0)<<5UL)))
...
#define XRDC_MDA_DID_FIELD_USED                    ((uint32)0x00000000<<XRDC_MDA_DID_SELECT_SHIFT_U32)
