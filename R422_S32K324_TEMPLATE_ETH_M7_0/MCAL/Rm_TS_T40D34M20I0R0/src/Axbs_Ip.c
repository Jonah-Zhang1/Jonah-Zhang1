...
#define RM_AXBS_IP_AR_RELEASE_MINOR_VERSION_C         4
#define RM_AXBS_IP_AR_RELEASE_REVISION_VERSION_C      0
#define RM_AXBS_IP_SW_MAJOR_VERSION_C                 2
...
void Axbs_Ip_DeInit(const Axbs_Ip_ConfigType * pAxbsConfig)
{
    ...
    const uint32 s_PRSResetValueArray[2]  = AXBS_IP_PRS_RESET_VALUE_ARRAY_U32;
    /* Array store CRS register default value of instances*/
    const uint32 s_CRSResetValueArray[2]  = AXBS_IP_CRS_RESET_VALUE_ARRAY_U32;
