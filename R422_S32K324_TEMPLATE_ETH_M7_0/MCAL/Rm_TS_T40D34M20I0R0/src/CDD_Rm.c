...
*
* @return       Rm_Sema42_CoreType     Index of the semaphore owner if the semaphore is locked,
...
{
    Rm_Ipw_Xbic_EnableMasterFeedbackCheck(xbicInstance, masterPort, bFeedbackCheckEnable);
}
...
{
    Rm_Ipw_Xbic_EnableSlaveEDCCheck(xbicInstance, slavePort, bEDCCheckEnable);
}
...
{
    Rm_Ipw_Xbic_GetErrorStatus(u32XbicInstance,pErrorInfo);
}
...
{
    Rm_Ipw_Xbic_ErrorInjection(u32XbicInstance, slaveTarget, masterTargetID, synDecode);
}
