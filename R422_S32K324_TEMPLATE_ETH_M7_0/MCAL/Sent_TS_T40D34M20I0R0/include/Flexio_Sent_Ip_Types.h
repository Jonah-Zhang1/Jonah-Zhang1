...
#define FLEXIO_SENT_IP_TYPES_AR_RELEASE_MINOR_VERSION       4
#define FLEXIO_SENT_IP_TYPES_AR_RELEASE_REVISION_VERSION    0
#define FLEXIO_SENT_IP_TYPES_SW_MAJOR_VERSION               2
...
typedef enum
{
    SENT_RECOMMENDED_IMPLEMENTATION_256_ELEMENT    = 0U,   /*!< CRC Recommended Implementation: Implementation using 256 Element Array */
    SENT_RECOMMENDED_IMPLEMENTATION_16_ELEMENT     = 1U,   /*!< CRC Recommended Implementation: Implementation using 16 Element Array */
    SENT_LEGACY_IMPLEMENTATION                      = 2U,   /*!< CRC Legacy Implementation */
...
#endif
    Sent_StatusCRCImplementType     Crc;        /*!< CRC implementation type */
