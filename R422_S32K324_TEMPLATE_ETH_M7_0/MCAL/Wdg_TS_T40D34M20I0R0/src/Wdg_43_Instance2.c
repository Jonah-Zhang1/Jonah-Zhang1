...
#define WDG_43_INSTANCE2_AR_RELEASE_MINOR_VERSION_C     4
#define WDG_43_INSTANCE2_AR_RELEASE_REVISION_VERSION_C  0
#define WDG_43_INSTANCE2_SW_MAJOR_VERSION_C             2
...
#if (WDG_ENABLE_SET_SERVICE_ADDRESS_INSTANCE2 == STD_ON)
#if (WDG_DIRECT_SERVICE_INSTANCE2 == STD_ON)
/**
...
**/
Std_ReturnType Wdg_43_Instance2_SetServiceAddress(uint32 ServiceAddress)
{
    return Wdg_ChannelSetServiceAddress(WDG_IPW_INSTANCE2, ServiceAddress);
}
#endif
#endif
#endif
