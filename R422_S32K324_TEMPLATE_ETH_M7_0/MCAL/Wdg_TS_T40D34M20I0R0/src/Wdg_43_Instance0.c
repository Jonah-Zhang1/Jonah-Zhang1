...
#define WDG_43_INSTANCE0_SW_MAJOR_VERSION_C             2
...
#if (WDG_ENABLE_SET_SERVICE_ADDRESS_INSTANCE0 == STD_ON)
#if (WDG_DIRECT_SERVICE_INSTANCE0 == STD_ON)
/**
...
**/
Std_ReturnType Wdg_43_Instance0_SetServiceAddress(uint32 ServiceAddress)
{
    return Wdg_ChannelSetServiceAddress(WDG_IPW_INSTANCE0, ServiceAddress);
}
#endif
#endif
#endif
