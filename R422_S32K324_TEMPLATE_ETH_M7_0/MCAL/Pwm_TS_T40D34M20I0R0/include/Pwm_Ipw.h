...
#if ((PWM_DEV_ERROR_DETECT == STD_ON) && (PWM_OFFSET_PLAUSABILITY == STD_ON))
/**
* @brief        Pwm_Ipw_ValidateParamOffset
* @details      This function will validate Offset parameter with default period and duty cycle
*               of all channels
*
* @param[in]    IpConfig       Pointer to PWM top configuration structure
*
* @return       uint8          Error ID
*
*/
uint8 Pwm_Ipw_ValidateParamOffset(const Pwm_IpwChannelConfigType * const IpConfig);
