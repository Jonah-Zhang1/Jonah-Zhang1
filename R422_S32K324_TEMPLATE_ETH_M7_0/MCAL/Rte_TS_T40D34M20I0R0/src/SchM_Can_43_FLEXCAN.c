...
#define SCHM_CAN_43_FLEXCAN_AR_RELEASE_MINOR_VERSION_C     4
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_00(void)
{
    ...
    if(0UL == reentry_guard_CAN_EXCLUSIVE_AREA_00[u32CoreId])
    {
        ...
        msr_CAN_EXCLUSIVE_AREA_00[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_00[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_01(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_01[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_01[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_02(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_02[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_02[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_03(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_03[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_03[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_04(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_04[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_04[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_05(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_05[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_05[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_06(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_06[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_06[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_07(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_07[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_07[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_08(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_08[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_08[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_09(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_09[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_09[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_10(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_10[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_10[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_11(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_11[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_11[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_12(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_12[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_12[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_13(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_13[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_13[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_14(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_14[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_14[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_15(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_15[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_15[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_16(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_16[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_16[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_17(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_17[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_17[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_18(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_18[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_18[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_19(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_19[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_19[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_20(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_CAN_EXCLUSIVE_AREA_20[u32CoreId] = OsIf_Trusted_Call_Return(Can_43_FLEXCAN_schm_read_msr);
#else
        msr_CAN_EXCLUSIVE_AREA_20[u32CoreId] = Can_43_FLEXCAN_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
