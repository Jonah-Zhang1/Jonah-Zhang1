...
#define TRGMUX_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION        4
 ...
 *
 */
extern void hwAcc_SetInputForOutput(TRGMUX_Type * const pTrgmux, const uint32 Input, const uint32 Output);
