...
#define CDD_MCL_AR_RELEASE_MINOR_VERSION        4
...
#if ((CDD_MCL_AR_RELEASE_MAJOR_VERSION != DET_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_MCL_AR_RELEASE_MINOR_VERSION != DET_AR_RELEASE_MINOR_VERSION))
...
#if ((CDD_MCL_AR_RELEASE_MAJOR_VERSION != DEM_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_MCL_AR_RELEASE_MINOR_VERSION != DEM_AR_RELEASE_MINOR_VERSION))
...
#if (STD_ON == MCL_CACHE_IS_AVAILABLE)
#if (STD_ON == MCL_DEM_IS_AVAILABLE)
LOCAL_INLINE void Mcl_Dem_ReportErrorStatus(const Std_ReturnType Status, const uint32 DemState, uint32 DemId)
{
 ...
 * */
LOCAL_INLINE void Mcl_CacheEnable(Mcl_CacheType CacheType)
{
#if (STD_ON == MCL_DEM_IS_AVAILABLE)
 ...
 * */
LOCAL_INLINE void Mcl_CacheDisable(Mcl_CacheType CacheType)
{
#if (STD_ON == MCL_DEM_IS_AVAILABLE)
    Std_ReturnType Status = E_OK;
#endif /* #if (STD_ON == MCL_DEM_IS_AVAILABLE) */
 ...
 * */
LOCAL_INLINE void Mcl_CacheInvalidate(Mcl_CacheType CacheType)
{
#if (STD_ON == MCL_DEM_IS_AVAILABLE)
    Std_ReturnType Status = E_OK;
#endif /* #if (STD_ON == MCL_DEM_IS_AVAILABLE) */
 ...
 * */
LOCAL_INLINE void Mcl_CacheClean(Mcl_CacheType CacheType, boolean EnInvalidate)
{
#if (STD_ON == MCL_DEM_IS_AVAILABLE)
    Std_ReturnType Status = E_OK;
#endif /* #if (STD_ON == MCL_DEM_IS_AVAILABLE) */
 ...
 * */
LOCAL_INLINE void Mcl_CacheInvalidateByAddr(Mcl_CacheType CacheType, uint32 Addr, uint32 Length)
{
#if (STD_ON == MCL_DEM_IS_AVAILABLE)
    Std_ReturnType Status = E_OK;
#endif /* #if (STD_ON == MCL_DEM_IS_AVAILABLE) */
 ...
 * */
LOCAL_INLINE void Mcl_CacheCleanByAddr(Mcl_CacheType CacheType, boolean EnInvalidate, uint32 Addr, uint32 Length)
{
#if (STD_ON == MCL_DEM_IS_AVAILABLE)
    Std_ReturnType Status = E_OK;
#endif /* #if (STD_ON == MCL_DEM_IS_AVAILABLE) */
