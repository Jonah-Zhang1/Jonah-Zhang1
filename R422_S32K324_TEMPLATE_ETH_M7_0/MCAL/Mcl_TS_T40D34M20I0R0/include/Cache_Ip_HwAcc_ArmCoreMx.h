...
#define CACHE_IP_HWACC_ARMCOREMX_AR_RELEASE_MINOR_VERSION        4
...
*                                       FUNCTION PROTOTYPES
==================================================================================================*/
LOCAL_INLINE void hwAcc_ArmCoreMx_InstructionCacheInvalidate(void)
{
...
LOCAL_INLINE void hwAcc_ArmCoreMx_DataCacheInvalidate(void)
{
    uint32 cacheSetSize;
    uint32 cacheWaySize;
    uint32 setIdx;
...
LOCAL_INLINE void hwAcc_ArmCoreMx_InstructionCacheClean(const boolean enInvalidate)
{
...
LOCAL_INLINE void hwAcc_ArmCoreMx_DataCacheClean(const boolean enInvalidate)
{
    uint32 cacheSetSize;
    uint32 cacheWaySize;
    uint32 setIdx;
...
LOCAL_INLINE void hwAcc_ArmCoreMx_InstructionCacheInvalidateByAddr(const uint32 addr, const uint32 length)
{
...
LOCAL_INLINE void hwAcc_ArmCoreMx_DataCacheInvalidateByAddr(const uint32 addr, const uint32 length)
{
    uint32 cacheLineSize;
    uint32 tmpAddr;
    uint32 endAddr;
...
LOCAL_INLINE void hwAcc_ArmCoreMx_InstructionCacheCleanByAddr(const boolean enInvalidate, const uint32 addr, const uint32 length)
{
    if(TRUE == enInvalidate)
    {
...
LOCAL_INLINE void hwAcc_ArmCoreMx_DataCacheCleanByAddr(const boolean enInvalidate, const uint32 addr, const uint32 length)
{
    uint32 cacheLineSize;
    uint32 tmpAddr;
    uint32 endAddr;
...
LOCAL_INLINE void hwAcc_ArmCoreMx_InstructionCacheEnable(void)
{
...
LOCAL_INLINE void hwAcc_ArmCoreMx_DataCacheEnable(void)
{
    /* Enable Data Cache */
...
LOCAL_INLINE void hwAcc_ArmCoreMx_InstructionCacheDisable(void)
{
    MCAL_DATA_SYNC_BARRIER();
    MCAL_INSTRUCTION_SYNC_BARRIER();
...
LOCAL_INLINE void hwAcc_ArmCoreMx_DataCacheDisable(void)
{
    /* Disable Data Cache */
    S32_SCB->CCR &= ~DCACHE_CCR_EN_MASK;
    MCAL_DATA_SYNC_BARRIER();
