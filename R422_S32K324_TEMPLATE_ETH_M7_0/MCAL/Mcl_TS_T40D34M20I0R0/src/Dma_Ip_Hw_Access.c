...
#if (STD_ON == DMAMUX_IP_NOT_ALIGNED)
    static DMAMUX_IP_Type             * const Dma_Ip_paxHwv3MuxBase[DMAMUX_NOT_ALIGNED_CHCFG_COUNT] = DMAMUX_NOT_ALIGNED_BASE_PTRS;
#else
    static DMAMUX_Type             * const Dma_Ip_paxHwv3MuxBase[DMA_IP_DMAMUX_NOF_INST] = IP_DMAMUX_BASE_PTRS;
#endif
#endif
...
==================================================================================================*/
     ...
     (DMA_IP_DMAMUX_IS_AVAILABLE == STD_OFF) || \
...
void HwAccDmaCh_SetRequest_EnMuxSource(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, const uint32 LocValue)
{
    ...
    switch (LocHwVers)
    {
        ...
        case DMA_IP_HARDWARE_VERSION_3:
                    ...
                    hwv3AccInlineDmaCh_SetRequest_EnHwRequestMux((volatile Dma_Ip_MuxRegType*)&Dma_Ip_paxHwv3MuxBase[LocDmaMuxInst]->CHCFG[LocDmaMuxCh], LocValue);
                #else
            ...
            #endif /* #if (STD_ON == DMA_IP_DMAMUX_IS_AVAILABLE) */
        break;
#endif /* #if (STD_ON == DMA_IP_HWV3_IS_AVAILABLE) */
...
void HwAccDmaCh_SetRequest_MuxSource(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, const uint32 LocValue)
{
    ...
    switch (LocHwVers)
    {
        ...
        case DMA_IP_HARDWARE_VERSION_3:
                    ...
                    LocDmaCh = DMA_IP_DMAMUX_REG_CH_CONV(LocHwInst, LocHwCh);
                    LocDmaMuxCh = DMA_IP_DMAMUX_REG_INDEX_CONV(LocDmaCh);
                    hwv3AccInlineDmaCh_SetRequest_SourceMux((volatile Dma_Ip_MuxRegType*)&Dma_Ip_paxHwv3MuxBase[LocDmaMuxInst]->CHCFG[LocDmaMuxCh], LocValue);
                #else
                    LocDmaCh = ((LocHwInst * DMA_IP_TCD_NOF_HWV3_CH) + LocHwCh);
                    LocDmaMuxInst = LocDmaCh / DMA_IP_DMAMUX_NOF_CHANNELS;
                    LocDmaMuxCh = DMA_IP_DMAMUX_REG_INDEX_CONV(LocDmaCh % DMA_IP_DMAMUX_NOF_CHANNELS);
...
void HwAccDmaCh_SetRequest_EnMuxTrigger(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, const uint32 LocValue)
{
    ...
    switch (LocHwVers)
    {
        ...
        case DMA_IP_HARDWARE_VERSION_3:
                ...
                LocDmaCh = DMA_IP_DMAMUX_REG_CH_CONV(LocHwInst, LocHwCh);
                LocDmaMuxCh = DMA_IP_DMAMUX_REG_INDEX_CONV(LocDmaCh);
                hwv3AccInlineDmaCh_SetRequest_EnTriggerMux((volatile Dma_Ip_MuxRegType*)&Dma_Ip_paxHwv3MuxBase[LocDmaMuxInst]->CHCFG[LocDmaMuxCh], LocValue);
                #else
                LocDmaCh = ((LocHwInst * DMA_IP_TCD_NOF_HWV3_CH) + LocHwCh);
                LocDmaMuxInst = LocDmaCh / DMA_IP_DMAMUX_NOF_CHANNELS;
                LocDmaMuxCh = DMA_IP_DMAMUX_REG_INDEX_CONV(LocDmaCh % DMA_IP_DMAMUX_NOF_CHANNELS);
...
void HwAccDmaCh_GetStoreDstAddress(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, uint32 * const retValue)
{
    ...
    switch (LocHwVers)
    {
        ...
        #if (STD_ON == DMA_IP_VIRTUAL_ADDRESS_MAPPING_IS_AVAILABLE)
            *retValue = *((uint32*)HwAccDma_SetPhysicalToVirtualAddress(LocPhysicalAddress));
        #else
            *retValue = *((uint32*)LocPhysicalAddress);
        #endif /* STD_ON == DMA_IP_VIRTUAL_ADDRESS_MAPPING_IS_AVAILABLE */
        break;
#endif /* #if (STD_ON == DMA_IP_HWV3_IS_AVAILABLE) */
