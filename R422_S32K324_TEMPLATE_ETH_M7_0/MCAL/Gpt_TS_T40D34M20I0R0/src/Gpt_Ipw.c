...
static inline Gpt_ValueType Gpt_Ipw_EmiosGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo);
#endif
#if (RTC_IP_USED == STD_ON)
static inline Gpt_ValueType Gpt_Ipw_RtcGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo);
#endif
#if (STM_IP_USED == STD_ON)
static inline Gpt_ValueType Gpt_Ipw_StmGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo);
#endif
#if (PIT_IP_USED == STD_ON)
static inline Gpt_ValueType Gpt_Ipw_PitGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo);
#endif
/*==================================================================================================
*                                       LOCAL FUNCTIONS
==================================================================================================*/
...
/* Read the current target time before to read the elapsed time. */
    ...
    returnValue = Emios_Gpt_Ip_GetCounterValue(pHwChannelConfig->instance, pHwChannelConfig->channel);

        /* Check for interrupt status flag */
        if (0U != Emios_Gpt_Ip_GetInterruptFlag(pHwChannelConfig->instance, pHwChannelConfig->channel))
        {
...
static inline Gpt_ValueType Gpt_Ipw_RtcGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo)
{
        ...
        compareValue = Rtc_Ip_GetAPICompareRegister(pHwChannelConfig->instance);
        counterValue = Rtc_Ip_GetCounterRegister(pHwChannelConfig->instance);
        ...
        {
             returnValue = pReturnHwChannelInfo->uTargetTime - tempValue;
        }
        /*Check interrupt status flag*/
        if (0U != Rtc_Ip_GetStatusFlags((pHwChannelConfig->instance), RTC_IP_API_INTERRUPT))
        {
...
static inline Gpt_ValueType Gpt_Ipw_StmGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo)
{
        ...
        /* Read compare and counter registers */
        counterValue = Stm_Ip_GetCounterValue(pHwChannelConfig->instance);
        compareValue = Stm_Ip_GetCompareValue(pHwChannelConfig->instance, pHwChannelConfig->channel);
        ...
        /*Check interrupt status flag*/
        if (0U != Stm_Ip_GetInterruptFlag(pHwChannelConfig->instance, pHwChannelConfig->channel))
        {
            /* Channel counter was roll-over */
             pReturnHwChannelInfo->bChannelRollover = TRUE;
        }
...
static inline Gpt_ValueType Gpt_Ipw_PitGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo)
{
        ...
        returnValue = (uint32)((pReturnHwChannelInfo->uTargetTime) - Pit_Ip_GetCurrentTimer(pHwChannelConfig->instance, pHwChannelConfig->channel));

        /*Check the interrupt status flag*/
        if (0U != Pit_Ip_GetInterruptFlags(pHwChannelConfig->instance, pHwChannelConfig->channel))
        {
            /* Channel counter was roll-over */
             pReturnHwChannelInfo->bChannelRollover = TRUE;
        }
