 ...
 * @version 1.4
 * @date 2021-12-10
 * @brief Peripheral Access Layer for S32K342_I3C
 *
...
#if !defined(S32K342_I3C_H_)  /* Check if memory map has not been already included */
#define S32K342_I3C_H_
...
#endif  /* #if !defined(S32K342_I3C_H_) */
