 ...
 * @version 1.3
 * @date 2021-10-28
 * @brief Peripheral Access Layer for S32K312_I3C
 *
...
#if !defined(S32K312_I3C_H_)  /* Check if memory map has not been already included */
#define S32K312_I3C_H_
...
typedef struct {
  ...
  __IO uint32_t SERRWARNMASK;                      /**< Mask for SERRWARN reg bits to form status bit, offset: 0x110 */
...
#define IP_I3C_BASE                              (0x400C0000u)
/** Peripheral I3C base pointer */
#define IP_I3C                                   ((I3C_Type *)IP_I3C_BASE)
/** Array initializer of I3C peripheral base addresses */
#define IP_I3C_BASE_ADDRS                        { IP_I3C_BASE }
/** Array initializer of I3C peripheral base pointers */
#define IP_I3C_BASE_PTRS                         { IP_I3C }
...
#define I3C_MCONFIG_PERLOW_MASK                  (0x80U)
#define I3C_MCONFIG_PERLOW_SHIFT                 (7U)
#define I3C_MCONFIG_PERLOW_WIDTH                 (1U)
#define I3C_MCONFIG_PERLOW(x)                    (((uint32_t)(((uint32_t)(x)) << I3C_MCONFIG_PERLOW_SHIFT)) & I3C_MCONFIG_PERLOW_MASK)
...
#define I3C_SCONFIG_DDROK_WIDTH                  (1U)
...
#define I3C_SCTRL_MAPIDX_WIDTH                   (1U)
...
#define I3C_SCAPABILITIES_HDRSUPP_WIDTH          (2U)
...
#define I3C_SDYNADDR_DAVALID_WIDTH               (1U)
...
#define I3C_SDYNADDR_MAPSA_WIDTH                 (1U)
...
#define I3C_SDYNADDR_SA10B_WIDTH                 (3U)
...
#define I3C_SDYNADDR_KEY_WIDTH                   (16U)
...
#define I3C_SMSGMAPADDR_MAPLAST_WIDTH            (4U)
...
#define I3C_SMSGMAPADDR_LASTSTATIC_WIDTH         (1U)
...
#define I3C_SMSGMAPADDR_MAPLASTM1_WIDTH          (4U)
...
#define I3C_SMSGMAPADDR_MAPLASTM2_WIDTH          (4U)
...
/*! @name SERRWARNMASK - Mask for SERRWARN reg bits to form status bit */
/*! @{ */
...
#define I3C_SMAPCTRL1_SA10B_WIDTH                (3U)
...
#define I3C_IBIEXT2_EXT5_WIDTH                   (8U)
...
#define I3C_IBIEXT2_EXT6_WIDTH                   (8U)
...
#define I3C_IBIEXT2_EXT7_WIDTH                   (8U)
...
#endif  /* #if !defined(S32K312_I3C_H_) */
