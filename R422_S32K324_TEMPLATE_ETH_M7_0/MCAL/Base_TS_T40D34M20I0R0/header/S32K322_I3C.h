 ...
 * @version 1.0
 * @date 2021-12-03
 * @brief Peripheral Access Layer for S32K322_I3C
 *
...
#if !defined(S32K322_I3C_H_)  /* Check if memory map has not been already included */
#define S32K322_I3C_H_
...
#endif  /* #if !defined(S32K322_I3C_H_) */
