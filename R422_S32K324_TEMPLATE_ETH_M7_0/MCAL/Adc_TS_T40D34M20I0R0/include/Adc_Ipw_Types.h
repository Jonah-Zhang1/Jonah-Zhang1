...
#define ADC_IPW_BCTU_NOTIF_DATA_ALL             (BCTU_IP_NOTIF_ADC0 | BCTU_IP_NOTIF_ADC1 | BCTU_IP_NOTIF_ADC2)
#define ADC_IPW_BCTU_FIFO_NOTIF_ALL             (BCTU_IP_NOTIF_FIFO1 | BCTU_IP_NOTIF_FIFO2 )
#define ADC_IPW_BCTU_NOTIF_ALL                  (BCTU_IP_NOTIF_ALL)

typedef uint8 Adc_CtuTrigSrcType;                               /**< @brief ID of the Bctu Trigger Source */
