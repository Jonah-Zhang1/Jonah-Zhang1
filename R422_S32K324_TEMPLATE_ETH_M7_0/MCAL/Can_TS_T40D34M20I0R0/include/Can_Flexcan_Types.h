...
#define CAN_E_DATALOST              ((uint8)0x01U)
    ...
    */
    ...
    #define CAN_SID_GET_CONTROLLER_TX_ERROR_COUNTER     ((uint8)0x31U)
        ...
        #define CAN_SID_SETCLOCKMODE                        ((uint8)0x18U)
    #endif
    #if (CAN_ABORT_MB_API == STD_ON)
        /*! @brief Service ID of Can_AbortMb */
        #define CAN_SID_ABORT_MB                            ((uint8)0x19U)
    #endif
#endif /* CAN_DEV_ERROR_DETECT == STD_ON */
...
#if (CAN_TIMESTAMP_ENABLE == STD_ON)
#define CAN_SID_GET_CURRENT_TIME                        ((uint8)0x13)
#define CAN_SID_ENABLE_EGRESS_TIMESTAMP                 ((uint8)0x14)
#define CAN_SID_GET_EGRESS_TIMESTAMP                    ((uint8)0x15)
#define CAN_SID_GET_INGRESS_TIMESTAMP                   ((uint8)0x16)
#define CAN_SID_SET_CURRENT_TIME                        ((uint8)0x17)
#endif /* (CAN_TIMESTAMP_ENABLE == STD_ON) */
