...
#define ETH_IPW_SW_MAJOR_VERSION_C               2
#define ETH_IPW_SW_MINOR_VERSION_C               0
#define ETH_IPW_SW_PATCH_VERSION_C               0
...
#define ETH_IPW_DEM_ERROR_UNUSED_U32            ((uint32)GMAC_CTR_NUMBER_OF_COUNTERS)
...
==================================================================================================*/
    ...
    #define Eth_Ipw_Local_Macro_SelectPhyInterface(RmiiMiiSelBit)   OsIf_Trusted_Call1param(Eth_Ipw_SelectPhyInterface,(RmiiMiiSelBit))
#else
    #define Eth_Ipw_Local_Macro_SelectPhyInterface(RmiiMiiSelBit)   Eth_Ipw_SelectPhyInterface((RmiiMiiSelBit))
#endif
...
*
* @param[in]     RmiiMiiSelBit       RMII/MII select bit.
*
* @return        void
*/
void Eth_Ipw_SelectPhyInterface(uint32 RmiiMiiSelBit)
{
    IP_DCM_GPR->DCMRWF1 = (IP_DCM_GPR->DCMRWF1 & ~DCM_GPR_DCMRWF1_RMII_MII_SEL_MASK) | RmiiMiiSelBit;
}
                                         ...
                                         )
{
    ...
    if (IpwCtrlCfg->Eth_Ipw_pGmacCtrlConfig->Gmac_pCtrlConfig->MiiMode == GMAC_MII_MODE)
    {
        Eth_Ipw_Local_Macro_SelectPhyInterface(DCM_GPR_DCMRWF1_RMII_MII_SEL(0U));
    }
    else
    {
        Eth_Ipw_Local_Macro_SelectPhyInterface(DCM_GPR_DCMRWF1_RMII_MII_SEL(1U));
    }
