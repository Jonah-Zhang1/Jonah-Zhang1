...
#define I3C_IP_AR_RELEASE_MINOR_VERSION_TYPES     4
#define I3C_IP_AR_RELEASE_REVISION_VERSION_TYPES  0
#define I3C_IP_SW_MAJOR_VERSION_TYPES             2
...
#define I3C_IP_SLAVE_STATUS_HDRMATCHED          ((uint32)I3C_SSTATUS_HDRMATCHED_MASK)   /**< An HDR command matched this device’s I3C Dynamic Address */
...
*/
    ...
    #define I3C_IP_CCC_DEFSLVS_BROADCAST   (0x08U)    /**< Define list of slaves */
    ...
    #define I3C_IP_CCC_GETACCMST_DIRECT    (0x91U)    /**< Get accept mastership */
...
#if (STD_ON == I3C_IP_DMA_FEATURE_AVAILABLE)
    uint8 DmaTxChannel;                                                 /**< DMA Tx channel ID */
    uint8 DmaRxChannel;                                                 /**< DMA Rx channel ID */
#endif /* I3C_IP_DMA_FEATURE_AVAILABLE */
#if (STD_ON == I3C_IP_ENABLE_SLAVE_REQUESTS)
