...
#define I3C_IP_AR_RELEASE_MINOR_VERSION_HWACCESS     4
#define I3C_IP_AR_RELEASE_REVISION_VERSION_HWACCESS  0
#define I3C_IP_SW_MAJOR_VERSION_HWACCESS             2
                                           ...
                                           const I3c_Ip_MasterConfigType * const Config)
{
    ...
    RegValue |= I3C_MCONFIG_DISTO(Config->DisableTimeout ? 1U : 0U) |
                ...
                I3C_MCONFIG_ODSTOP(Config->OpenDrainStop ? 1U : 0U) |
...
*
* @param[in] Base           Table of base addresses for I3C instances
* @param[in] AddressType    Address type: if FALSE is Dynamic Address, if TRUE is I2C-like Static Address
...
{
    uint32 RegValue = Base->SMAPCTRL1;
    uint8 Addr7Bit;
    uint8 Addr10BitExt;
    ...
    RegValue |= I3C_SMAPCTRL1_ENA(Enable ? 1U : 0U);
    RegValue |= I3C_SMAPCTRL1_MAPSA(AddressType ? 1U : 0U);
    RegValue |= I3C_SMAPCTRL1_NACK(Nack ? 1U : 0U);

    Addr7Bit = (uint8)(Address & (I3C_SMAPCTRL1_ADDR_MASK >> I3C_SMAPCTRL1_ADDR_SHIFT));
    Addr10BitExt = (uint8)((Address & (I3C_SMAPCTRL1_SA10B_MASK >> (I3C_SMAPCTRL1_SA10B_SHIFT - I3C_SMAPCTRL1_ADDR_WIDTH))) >> I3C_SMAPCTRL1_ADDR_WIDTH);

    RegValue |= I3C_SMAPCTRL1_SA10B(Addr10BitExt) | I3C_SMAPCTRL1_ADDR(Addr7Bit);
