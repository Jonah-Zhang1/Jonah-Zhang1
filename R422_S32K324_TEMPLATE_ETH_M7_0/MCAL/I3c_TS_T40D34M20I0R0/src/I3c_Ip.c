...
#define I3C_IP_AR_RELEASE_MINOR_VERSION_C       4
#define I3C_IP_AR_RELEASE_REVISION_VERSION_C    0
#define I3C_IP_SW_MAJOR_VERSION_C               2
...
/* Maximum size for the In-Band interrupt data */
...
#define I3C_MASTER_DMA_CHANNEL_CONFIG_LIST_SIZE  (12U)
static Dma_Ip_LogicChannelTransferListType I3c_Ip_axDmaMasterTransferListReceive[I3C_MASTER_DMA_CHANNEL_CONFIG_LIST_SIZE];
static Dma_Ip_LogicChannelTransferListType I3c_Ip_axDmaMasterTransferListSend[I3C_MASTER_DMA_CHANNEL_CONFIG_LIST_SIZE];

/* Structures for configuration the slave DMA channel */
#define I3C_SLAVE_DMA_CHANNEL_CONFIG_LIST_SIZE   (12U)
static Dma_Ip_LogicChannelTransferListType I3c_Ip_axDmaSlaveTransferListReceive[I3C_SLAVE_DMA_CHANNEL_CONFIG_LIST_SIZE];
static Dma_Ip_LogicChannelTransferListType I3c_Ip_axDmaSlaveTransferListSend[I3C_SLAVE_DMA_CHANNEL_CONFIG_LIST_SIZE];
#endif /* I3C_IP_DMA_FEATURE_AVAILABLE */
...
#if (STD_ON == I3C_IP_DMA_FEATURE_AVAILABLE)
static void I3c_Ip_DmaMasterInit(void);
...
static void I3c_Ip_MasterRxDmaConfig(I3C_Type * const Base,
                                     const I3c_Ip_MasterStateType * const Master);
static void I3c_Ip_DmaSlaveInit(void);
...
static void I3c_Ip_SlaveRxDmaConfig(I3C_Type * const Base,
                                    const I3c_Ip_SlaveStateType * const Slave);
void I3c_Ip_SlaveTxDmaCompleteTransfer(const uint8 Instance);
#endif /* I3C_IP_DMA_FEATURE_AVAILABLE */
...
static void I3c_Ip_MasterSlaveStartEventHandler(I3C_Type * const Base,
                                                const I3c_Ip_MasterStateType * const Master);
static void I3c_Ip_MasterArbitrationLostEventHandler(I3C_Type * const Base,
                                                     I3c_Ip_MasterStateType * const Master);
static void I3c_Ip_MasterNowMasterEventHandler(const I3c_Ip_MasterStateType * const Master);
...
static void I3c_Ip_MasterCheckCompletionEvents(I3C_Type * const Base,
                                               I3c_Ip_MasterStateType * const Master);
static void I3c_Ip_MasterCheckSlaveRequestEvents(I3C_Type * const Base,
                                                 I3c_Ip_MasterStateType * const Master);
...
static uint8 I3c_Ip_ComputeI2cBaudRate(const uint8 PpBaudCount,
                                       ...
                                       const uint32 FunctionalClock,
                                       const uint32 TargetI2cBaudRate);
static void I3c_Ip_MasterBlockingConfigFifo(const uint8 Instance);
...
/*FUNCTION**********************************************************************
*
* Function Name : I3c_Ip_DmaMasterInit
* Description   : This function initializes all DMA parameters for I3c master.
*
* END**************************************************************************/
static void I3c_Ip_DmaMasterInit
(
    void
)
{
    ...
    I3c_Ip_axDmaMasterTransferListSend[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    I3c_Ip_axDmaMasterTransferListSend[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    I3c_Ip_axDmaMasterTransferListSend[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters */
    I3c_Ip_axDmaMasterTransferListSend[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    I3c_Ip_axDmaMasterTransferListSend[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    I3c_Ip_axDmaMasterTransferListSend[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    I3c_Ip_axDmaMasterTransferListSend[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    I3c_Ip_axDmaMasterTransferListSend[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Disable Hw auto request */
    I3c_Ip_axDmaMasterTransferListSend[8u].Param = DMA_IP_CH_SET_CONTROL_DIS_AUTO_REQUEST;
    /* Adjustment added to source address parameter */
    I3c_Ip_axDmaMasterTransferListSend[9u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_LAST_ADDR_ADJ;
    I3c_Ip_axDmaMasterTransferListSend[10u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_LAST_ADDR_ADJ;
    /* Enable major interrupt parammeter */
    I3c_Ip_axDmaMasterTransferListSend[11U].Param = DMA_IP_CH_SET_CONTROL_EN_MAJOR_INTERRUPT;

    /* Destination configuration values */
    I3c_Ip_axDmaMasterTransferListSend[4u].Value = 0U;
    /* Disable Hw auto request value */
    I3c_Ip_axDmaMasterTransferListSend[8u].Value = 0U;
    /* Adjustment added to source and destination address value */
    I3c_Ip_axDmaMasterTransferListSend[9u].Value = 0U;
    I3c_Ip_axDmaMasterTransferListSend[10u].Value = 4U;
    /* Enable major interrupt value */
    I3c_Ip_axDmaMasterTransferListSend[11U].Value = 0U;

    /* Configure DMA channel for receive transfers*/
    /* Source configuration parameters  */
    I3c_Ip_axDmaMasterTransferListReceive[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    I3c_Ip_axDmaMasterTransferListReceive[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    I3c_Ip_axDmaMasterTransferListReceive[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters  */
    I3c_Ip_axDmaMasterTransferListReceive[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    I3c_Ip_axDmaMasterTransferListReceive[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    I3c_Ip_axDmaMasterTransferListReceive[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    I3c_Ip_axDmaMasterTransferListReceive[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    I3c_Ip_axDmaMasterTransferListReceive[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Disable Hw auto request */
    I3c_Ip_axDmaMasterTransferListReceive[8u].Param = DMA_IP_CH_SET_CONTROL_DIS_AUTO_REQUEST;
    /* Adjustment added to source address parameter */
    I3c_Ip_axDmaMasterTransferListReceive[9u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_LAST_ADDR_ADJ;
    I3c_Ip_axDmaMasterTransferListReceive[10u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_LAST_ADDR_ADJ;
    /* Enable major interrupt parammeter */
    I3c_Ip_axDmaMasterTransferListReceive[11U].Param = DMA_IP_CH_SET_CONTROL_EN_MAJOR_INTERRUPT;

    /* Source configuration values */
    I3c_Ip_axDmaMasterTransferListReceive[1u].Value = 0U;
    /* Disable Hw auto request value */
    I3c_Ip_axDmaMasterTransferListReceive[8u].Value = 1U;
    /* Adjustment added to source and destination address value */
    I3c_Ip_axDmaMasterTransferListReceive[9u].Value = 0U;
    I3c_Ip_axDmaMasterTransferListReceive[10u].Value = 0U;
    /* Enable major interrupt value */
    I3c_Ip_axDmaMasterTransferListReceive[11U].Value = 0U;
}
...
)
{
    ...
    I3c_Ip_axDmaMasterTransferListSend[0u].Value = (uint32)(&(Master->TxDataBuffer[0]));
    I3c_Ip_axDmaMasterTransferListSend[4u].Value = 0U;
    if (Master->TransferOption.TransferSize == I3C_IP_TRANSFER_HALF_WORDS)
    {
        DmaCtrl |= I3C_MDMACTRL_DMAWIDTH(2U);
        I3c_Ip_axDmaMasterTransferListSend[1u].Value = 2U;
        I3c_Ip_axDmaMasterTransferListSend[2u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaMasterTransferListSend[3u].Value = (uint32)(&(Base->MWDATAH));
        I3c_Ip_axDmaMasterTransferListSend[5u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaMasterTransferListSend[6u].Value = 2U;
        I3c_Ip_axDmaMasterTransferListSend[7u].Value = (Master->BufferSize >> 1U) - 1U;
    }
    else
    {
        DmaCtrl |= I3C_MDMACTRL_DMAWIDTH(1U);
        I3c_Ip_axDmaMasterTransferListSend[1u].Value = 1U;
        I3c_Ip_axDmaMasterTransferListSend[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaMasterTransferListSend[3u].Value = (uint32)(&(Base->MWDATAB));
        I3c_Ip_axDmaMasterTransferListSend[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaMasterTransferListSend[6u].Value = 1U;
        I3c_Ip_axDmaMasterTransferListSend[7u].Value = Master->BufferSize - 1U;
    }
    ...
    eDmaReturnStatus = Dma_Ip_SetLogicChannelTransferList(Master->DmaTxChannel, I3c_Ip_axDmaMasterTransferListSend, I3C_MASTER_DMA_CHANNEL_CONFIG_LIST_SIZE);
#if (STD_ON == I3C_IP_DEV_ERROR_DETECT)
    DevAssert(DMA_IP_STATUS_SUCCESS == eDmaReturnStatus);
#endif
    /* Start DMA channel */
...
)
{
    ...
    {
        DmaCtrl |= I3C_MDMACTRL_DMAWIDTH(2U);
        I3c_Ip_axDmaMasterTransferListReceive[0u].Value = (uint32)(&(Base->MRDATAH));
        I3c_Ip_axDmaMasterTransferListReceive[2u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaMasterTransferListReceive[4u].Value = 2U;
        I3c_Ip_axDmaMasterTransferListReceive[5u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaMasterTransferListReceive[6u].Value = 2U;
        I3c_Ip_axDmaMasterTransferListReceive[7u].Value = (Master->BufferSize >> 1U);
    }
    else
    {
        DmaCtrl |= I3C_MDMACTRL_DMAWIDTH(1U);
        I3c_Ip_axDmaMasterTransferListReceive[0u].Value = (uint32)(&(Base->MRDATAB));
        I3c_Ip_axDmaMasterTransferListReceive[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaMasterTransferListReceive[4u].Value = 1U;
        I3c_Ip_axDmaMasterTransferListReceive[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaMasterTransferListReceive[6u].Value = 1U;
        I3c_Ip_axDmaMasterTransferListReceive[7u].Value = Master->BufferSize;
    }
    I3c_Ip_axDmaMasterTransferListReceive[1u].Value = 0U;
    I3c_Ip_axDmaMasterTransferListReceive[3u].Value = (uint32)(&(Master->RxDataBuffer[0]));
...
#endif
    /* Configure DMA channel */
    (void)Dma_Ip_SetLogicChannelTransferList(Master->DmaRxChannel, I3c_Ip_axDmaMasterTransferListReceive, I3C_MASTER_DMA_CHANNEL_CONFIG_LIST_SIZE);
#if (STD_ON == I3C_IP_DEV_ERROR_DETECT)
    DevAssert(DMA_IP_STATUS_SUCCESS == eDmaReturnStatus);
#endif
    /* Start DMA channel */
...
/*FUNCTION**********************************************************************
*
* Function Name : I3c_Ip_DmaSlaveInit
* Description   : This function initializes all DMA parameters for I3c slave.
*
* END**************************************************************************/
static void I3c_Ip_DmaSlaveInit
(
    void
)
{
    /* Configure DMA channel for send transfers */
    /* Source configuration parameters  */
    I3c_Ip_axDmaSlaveTransferListSend[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    I3c_Ip_axDmaSlaveTransferListSend[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    I3c_Ip_axDmaSlaveTransferListSend[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters */
    I3c_Ip_axDmaSlaveTransferListSend[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    I3c_Ip_axDmaSlaveTransferListSend[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    I3c_Ip_axDmaSlaveTransferListSend[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    I3c_Ip_axDmaSlaveTransferListSend[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    I3c_Ip_axDmaSlaveTransferListSend[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Disable Hw auto request */
    I3c_Ip_axDmaSlaveTransferListSend[8u].Param = DMA_IP_CH_SET_CONTROL_DIS_AUTO_REQUEST;
    /* Adjustment added to source and destination address parameter */
    I3c_Ip_axDmaSlaveTransferListSend[9u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_LAST_ADDR_ADJ;
    I3c_Ip_axDmaSlaveTransferListSend[10u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_LAST_ADDR_ADJ;
    /* Enable major interrupt parammeter */
    I3c_Ip_axDmaSlaveTransferListSend[11U].Param = DMA_IP_CH_SET_CONTROL_EN_MAJOR_INTERRUPT;

    /* Destination configuration values */
    I3c_Ip_axDmaSlaveTransferListSend[4u].Value = 0U;
    /* Disable Hw auto request value */
    I3c_Ip_axDmaSlaveTransferListSend[8u].Value = 1U;
    /* Adjustment added to source and destination address value */
    I3c_Ip_axDmaSlaveTransferListSend[9u].Value = 0U;
    I3c_Ip_axDmaSlaveTransferListSend[10u].Value = 0U;
    /* Enable major interrupt value */
    I3c_Ip_axDmaSlaveTransferListSend[11U].Value = 1U;

    /* Configure DMA channel for receive transfers*/
    /* Source configuration parameters  */
    I3c_Ip_axDmaSlaveTransferListReceive[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    I3c_Ip_axDmaSlaveTransferListReceive[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    I3c_Ip_axDmaSlaveTransferListReceive[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters  */
    I3c_Ip_axDmaSlaveTransferListReceive[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    I3c_Ip_axDmaSlaveTransferListReceive[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    I3c_Ip_axDmaSlaveTransferListReceive[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    I3c_Ip_axDmaSlaveTransferListReceive[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    I3c_Ip_axDmaSlaveTransferListReceive[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Disable Hw auto request */
    I3c_Ip_axDmaSlaveTransferListReceive[8u].Param = DMA_IP_CH_SET_CONTROL_DIS_AUTO_REQUEST;
    /* Adjustment added to source and destination address parameter */
    I3c_Ip_axDmaSlaveTransferListReceive[9u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_LAST_ADDR_ADJ;
    I3c_Ip_axDmaSlaveTransferListReceive[10u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_LAST_ADDR_ADJ;
    /* Enable major interrupt parammeter */
    I3c_Ip_axDmaSlaveTransferListReceive[11U].Param = DMA_IP_CH_SET_CONTROL_EN_MAJOR_INTERRUPT;

    /* Source configuration values */
    I3c_Ip_axDmaSlaveTransferListReceive[1u].Value = 0U;
    /* Disable Hw auto request value */
    I3c_Ip_axDmaSlaveTransferListReceive[8u].Value = 1U;
    /* Adjustment added to source and destination address value */
    I3c_Ip_axDmaSlaveTransferListReceive[9u].Value = 0U;
    I3c_Ip_axDmaSlaveTransferListReceive[10u].Value = 0U;
    /* Enable major interrupt value */
    I3c_Ip_axDmaSlaveTransferListReceive[11U].Value = 0U;
}
...
)
{
    ...
    /* Source and Destination configuration values */
    I3c_Ip_axDmaSlaveTransferListSend[0u].Value = (uint32)(&(Slave->DataBuffer[0]));
    I3c_Ip_axDmaSlaveTransferListSend[4u].Value = 0U;
    if (Slave->TransferSize == I3C_IP_TRANSFER_HALF_WORDS)
    {
        DmaCtrl |= I3C_SDMACTRL_DMAWIDTH(2U);
        I3c_Ip_axDmaSlaveTransferListSend[1u].Value = 2U;
        I3c_Ip_axDmaSlaveTransferListSend[2u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaSlaveTransferListSend[3u].Value = (uint32)(&(Base->MWDATAH));
        I3c_Ip_axDmaSlaveTransferListSend[5u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaSlaveTransferListSend[6u].Value = 2U;
        I3c_Ip_axDmaSlaveTransferListSend[7u].Value = (Slave->BufferSize >> 1U) - 1U;
    }
    else
    {
        DmaCtrl |= I3C_SDMACTRL_DMAWIDTH(1U);
        I3c_Ip_axDmaSlaveTransferListSend[1u].Value = 1U;
        I3c_Ip_axDmaSlaveTransferListSend[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaSlaveTransferListSend[3u].Value = (uint32)(&(Base->MWDATAB));
        I3c_Ip_axDmaSlaveTransferListSend[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaSlaveTransferListSend[6u].Value = 1U;
        I3c_Ip_axDmaSlaveTransferListSend[7u].Value = Slave->BufferSize - 1U;
    }
...
#endif
    /* Configure DMA channel */
    eDmaReturnStatus = Dma_Ip_SetLogicChannelTransferList(Slave->DmaTxChannel, I3c_Ip_axDmaSlaveTransferListSend, I3C_SLAVE_DMA_CHANNEL_CONFIG_LIST_SIZE);
#if (STD_ON == I3C_IP_DEV_ERROR_DETECT)
    DevAssert(DMA_IP_STATUS_SUCCESS == eDmaReturnStatus);
#endif
    /* Start DMA channel */
...
)
{
    ...
    {
        DmaCtrl |= I3C_SDMACTRL_DMAWIDTH(2U);
        I3c_Ip_axDmaSlaveTransferListReceive[0u].Value = (uint32)(&(Base->MRDATAH));
        I3c_Ip_axDmaSlaveTransferListReceive[2u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaSlaveTransferListReceive[4u].Value = 2U;
        I3c_Ip_axDmaSlaveTransferListReceive[5u].Value = DMA_IP_TRANSFER_SIZE_2_BYTE;
        I3c_Ip_axDmaSlaveTransferListReceive[6u].Value = 2U;
        I3c_Ip_axDmaSlaveTransferListReceive[7u].Value = (Slave->BufferSize >> 1U);
    }
    else
    {
        DmaCtrl |= I3C_SDMACTRL_DMAWIDTH(1U);
        I3c_Ip_axDmaSlaveTransferListReceive[0u].Value = (uint32)(&(Base->MRDATAB));
        I3c_Ip_axDmaSlaveTransferListReceive[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaSlaveTransferListReceive[4u].Value = 1U;
        I3c_Ip_axDmaSlaveTransferListReceive[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
        I3c_Ip_axDmaSlaveTransferListReceive[6u].Value = 1U;
        I3c_Ip_axDmaSlaveTransferListReceive[7u].Value = Slave->BufferSize;
    }
    I3c_Ip_axDmaSlaveTransferListReceive[1u].Value = 0U;
    I3c_Ip_axDmaSlaveTransferListReceive[3u].Value = (uint32)(&(Slave->DataBuffer[0]));
...
#endif
    /* Configure DMA channel */
    eDmaReturnStatus = Dma_Ip_SetLogicChannelTransferList(Slave->DmaRxChannel, I3c_Ip_axDmaSlaveTransferListReceive, I3C_SLAVE_DMA_CHANNEL_CONFIG_LIST_SIZE);
#if (STD_ON == I3C_IP_DEV_ERROR_DETECT)
    DevAssert(DMA_IP_STATUS_SUCCESS == eDmaReturnStatus);
#endif
    /* Start DMA channel */
                                                ...
                                                I3c_Ip_MasterStateType * const Master)
{
    ...
    while ((Master->BufferSize > 0U) && (RxCount >= 2U))
    {
        ...
        Master->RxDataBuffer[0U] = (uint8)((RegValue & I3C_MRDATAH_LSB_MASK) >> I3C_MRDATAH_LSB_SHIFT);
        Master->RxDataBuffer[1U] = (uint8)((RegValue & I3C_MRDATAH_MSB_MASK) >> I3C_MRDATAH_MSB_SHIFT);
    ...
    if ((Master->BufferSize == 1U) && (RxCount > 0U))
    {
        Master->RxDataBuffer[0U] = I3c_Ip_ReadMRDATABRegister(Base);
...
static void I3c_Ip_MasterReceiveMessage(const I3C_Type * const Base,
                                        I3c_Ip_MasterStateType * const Master)
{
    if (Master->TransferOption.TransferSize == I3C_IP_TRANSFER_BYTES)
    {
                                               ...
                                               I3c_Ip_SlaveStateType * const Slave)
{
    ...
    while ((Slave->BufferSize > 0U) && (RxCount >= 2U))
    {
        ...
        Slave->DataBuffer[0U] = (uint8)((RegValue & I3C_SRDATAH_LSB_MASK) >> I3C_SRDATAH_LSB_SHIFT);
        Slave->DataBuffer[1U] = (uint8)((RegValue & I3C_SRDATAH_MSB_MASK) >> I3C_SRDATAH_MSB_SHIFT);
    ...
    /* Read the last byte in the case when reading half-words, but the Rx Buffer size is an odd number of bytes */
    if ((Slave->BufferSize == 1U) && (RxCount > 0U))
    {
        Slave->DataBuffer[0U] = I3c_Ip_ReadSRDATABRegister(Base);
...
static void I3c_Ip_SlaveReceiveMessage(const I3C_Type * const Base,
                                       I3c_Ip_SlaveStateType * const Slave)
{
    if (Slave->TransferSize == I3C_IP_TRANSFER_BYTES)
    {
                                     ...
                                     boolean SendStop)
{
    ...
    if (SendStop == TRUE)
    {
        ...
        if (I3c_Ip_MasterGetState(Base, (uint32)I3C_IP_MASTER_MODE_MSG_DDR) == TRUE)
        {
            /* Enter critical section */
...
#if (STD_ON == I3C_IP_DMA_FEATURE_AVAILABLE)
    if (Slave->TransferType == I3C_IP_USING_DMA)
    {
        /* Stop DMA Tx channel */
                                           ...
                                           I3c_Ip_SlaveStateType * const Slave)
{
    ...
    if (Slave->BufferSize == 0U)
    {
        ...
        if (I3c_Ip_SlaveCheckStatus(Base, (uint32)I3C_SSTATUS_STHDR_MASK) == TRUE)
        {
            if (Slave->Status == I3C_IP_STATUS_BUSY)
            {
...
static I3c_Ip_FifoTriggerLevelType I3c_Ip_MasterConvertRxSizeToWatermark(const I3c_Ip_MasterStateType * const Master)
{
    ...
    if (Master->TransferOption.BusType == I3C_IP_BUS_TYPE_I3C_DDR)
    {
                                               ...
                                               I3c_Ip_SlaveStateType * const Slave)
{
    ...
    if (((HdrDdrCmdCode & I3C_IP_SLAVE_HDR_DDR_DIRECTION_MASK) >> I3C_IP_SLAVE_HDR_DDR_DIRECTION_SHIFT) == 0U)
    {
                                                  ...
                                                  I3c_Ip_SlaveStateType * const Slave)
{
    ...
    if (I3c_Ip_SlaveCheckStatus(Base, (uint32)I3C_SSTATUS_STREQWR_MASK) == TRUE)
    {
        Slave->Direction = I3C_IP_READ;
        Slave->Status = I3C_IP_STATUS_BUSY;
    ...
    else if (I3c_Ip_SlaveCheckStatus(Base, (uint32)I3C_SSTATUS_STREQRD_MASK) == TRUE)
    {
        if (Slave->SlaveCallback != NULL_PTR)
        {
            Slave->SlaveCallback(I3C_IP_SLAVE_EVENT_TX_REQUEST);
                                            ...
                                            I3c_Ip_MasterStateType * const Master)
{
    ...
    if (IbiResp == (uint8)I3C_IP_IBI_RESP_NACK)
    {
        I3c_Ip_MasterEmitStop(Base, Master->IbiOptions.IbiSendStop);
        Master->Status = I3C_IP_STATUS_SUCCESS;
    }
                                                 ...
                                                 I3c_Ip_MasterStateType * const Master)
{
    ...
    if (Master->Status == I3C_IP_STATUS_CONTROL_DONE)
    {
        Master->Status = I3C_IP_STATUS_SUCCESS;
        I3c_Ip_MasterDisableInterrupts(Base, (uint32)I3C_MINTCLR_MCTRLDONE_MASK);
    }
                                              ...
                                              I3c_Ip_MasterStateType * const Master)
{
    ...
    if (Master->TransferOption.Direction == I3C_IP_READ)
    {
        if (Master->BufferSize > 0U)
        {
...
#if (STD_ON == I3C_IP_ENABLE_SLAVE_REQUESTS)
    if (Master->Status == I3C_IP_STATUS_IBI_WON)
    {
        TempCount = 0U;
...
static void I3c_Ip_MasterSlaveStartEventHandler(I3C_Type * const Base,
                                                const I3c_Ip_MasterStateType * const Master)
{
    if (I3c_Ip_MasterGetState(Base, (uint32)I3C_IP_MASTER_MODE_SLAVE_REQUEST) == TRUE)
    {
        if (Master->MasterCallback != NULL_PTR)
        {
...
#if (STD_ON == I3C_IP_ENABLE_SLAVE_REQUESTS)
        if (Master->IbiOptions.EmitAutoIbi == TRUE)
        {
                                    ...
                                    I3c_Ip_MasterStateType * const Master)
{
    ...
    if (Master->IbiResp == I3C_IP_IBI_RESP_NACK)
    {
        I3c_Ip_MasterEmitStop(Base, Master->IbiOptions.IbiSendStop);
        Master->Status = I3C_IP_STATUS_SUCCESS;
    }
    ...
    {
        if (Master->IbiResp == I3C_IP_IBI_RESP_MANUAL)
        {
                                         ...
                                         I3c_Ip_MasterStateType * const Master)
{
    ...
    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_TXNOTFULL_MASK) == FALSE)
    {
     ...
     /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_RXPEND_MASK) == FALSE)
    {
...
{
    /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_TXSEND_MASK) == FALSE)
    {
     ...
     /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_RXPEND_MASK) == FALSE)
    {
...
{
    /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_CHANDLED_MASK) == FALSE)
    {
     ...
     /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_CCC_MASK) == FALSE)
    {
    ...
    I3c_Ip_SlaveClearStatus(Base, ((uint32)I3C_SSTATUS_CHANDLED_MASK | I3C_SSTATUS_CCC_MASK));
}
...
{
    /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_START_MASK) == FALSE)
    {
        /* Handle Start event */
     ...
     /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_STOP_MASK) == FALSE)
    {
        /* Handle STOP event */
    ...
    /* Clear the interrupt status flags */
    I3c_Ip_SlaveClearStatus(Base, ((uint32)I3C_SSTATUS_START_MASK | I3C_SSTATUS_STOP_MASK));
}
...
{
    /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_DACHG_MASK) == FALSE)
    {
...
{
    /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_DDRMATCHED_MASK) == FALSE)
    {
    ...
    /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_MATCHED_MASK) == FALSE)
    {
    ...
    /* Clear the interrupt status flags */
    I3c_Ip_SlaveClearStatus(Base, ((uint32)I3C_SSTATUS_HDRMATCHED_MASK | I3C_SSTATUS_MATCHED_MASK));
}
...
{
    /* Check if the interrupt was spurious and call its handler */
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_EVENT_MASK) == FALSE)
    {
                                               ...
                                               I3c_Ip_MasterStateType * const Master)
{
    ...
    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_MCTRLDONE_MASK) == FALSE)
    {
        /* Handle Control done event */
        I3c_Ip_MasterControlDoneEventHandler(Base, Master);

        /* This is an exception of CPR_RTD_00028.i3c requirement. For blocking transfers,
           the driver waits for this status flag to set in order to signal a control request
           completion. Clearing the interrupt flag only when the interrupt was enabled ensures
           that this flag will not be cleared for blocking transfers, if an interrupt event fires.
           Possible interrupts during a blocking transfer are Slave Requests related. */
        I3c_Ip_MasterClearStatus(Base, (uint32)I3C_MSTATUS_MCTRLDONE_MASK);
    }
    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_COMPLETE_MASK) == FALSE)
    {
        /* Handle Complete event */
        I3c_Ip_MasterCompleteEventHandler(Base, Master);

        /* This is an exception of CPR_RTD_00028.i3c requirement. For blocking transfers,
           the driver waits for this status flag to set in order to signal a transfer
           completion. Clearing the interrupt flag only when the interrupt was enabled ensures
           that this flag will not be cleared for blocking transfers, if an interrupt event fires.
           Possible interrupts during a blocking transfer are Slave Requests related. */
        I3c_Ip_MasterClearStatus(Base, (uint32)I3C_MSTATUS_COMPLETE_MASK);
...
{
    /* Check if the interrupt was spurious, clear the interrupt, and call its handler */
    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_SLVSTART_MASK) == FALSE)
    {
        /* Handle Slave start event */
        I3c_Ip_MasterSlaveStartEventHandler(Base, Master);
    }

    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_IBIWON_MASK) == FALSE)
    {
        /* Handle Master Arbitration lost event */
        I3c_Ip_MasterArbitrationLostEventHandler(Base, Master);
    }

    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_NOWMASTER_MASK) == FALSE)
    {
        /* Handle Now Master event */
        I3c_Ip_MasterNowMasterEventHandler(Master);
    }

    /* Clear the interrupt */
    I3c_Ip_MasterClearStatus(Base, ((uint32)I3C_MSTATUS_SLVSTART_MASK | I3C_MSTATUS_IBIWON_MASK | I3C_MSTATUS_NOWMASTER_MASK));
}
...
static void I3c_Ip_MasterCheckErrorEvents(I3C_Type * const Base,
                                          I3c_Ip_MasterStateType * const Master)
{
    if (I3c_Ip_MasterCheckSpuriousInt(Base, (uint32)I3C_MINTMASKED_ERRWARN_MASK) == FALSE)
    {
        /* Handle error event */
                                         ...
                                         I3c_Ip_SlaveStateType * const Slave)
{
    ...
    if (I3c_Ip_SlaveCheckSpuriousInt(Base, (uint32)I3C_SINTMASKED_ERRWARN_MASK) == FALSE)
    {
        /* Handle error event */
...
static void I3c_Ip_MasterIRQHandler(const uint8 Instance)
{
    ...
    I3c_Ip_MasterCheckSlaveRequestEvents(Base, Master);
                                  ...
                                  I3c_Ip_MasterStateType * const Master)
{
    ...
    if (I3c_Ip_MasterCheckStatus(Base, (uint32)I3C_MSTATUS_TXNOTFULL_MASK) == TRUE)
    {
                                     ...
                                     I3c_Ip_MasterStateType * const Master)
{
    ...
    if (I3c_Ip_MasterCheckStatus(Base, (uint32)I3C_MSTATUS_RXPEND_MASK) == TRUE)
    {
        /* Read data from Rx FIFO */
        I3c_Ip_MasterReceiveMessage(Base, Master);
    }
                                                     ...
                                                     uint8 * SlaveIndex)
{
    ...
    if ((ReturnStatus == I3C_IP_STATUS_SUCCESS) && (I3c_Ip_MasterCheckStatus(Base, (uint32)I3C_MSTATUS_RXPEND_MASK) == TRUE))
    {
        TempCount = 0U;
        RxCount = (uint8)((Base->MDATACTRL & I3C_MDATACTRL_RXCOUNT_MASK) >> I3C_MDATACTRL_RXCOUNT_SHIFT);
        ...
        if ((I3c_Ip_MasterGetState(Base, (uint32)I3C_IP_MASTER_MODE_DAA) == TRUE) &&
                                      ...
                                      const I3c_Ip_BusType BusType)
{
    ...
    if (((FunctionalClock / PpDiv) > MaxPpBaudRate) || (PpDiv == 1U))
    {
        PpDiv++;
    }
                                       ...
                                       const uint32 TargetI2cBaudRate)
{
    ...
    I2cDiv = (uint8)(Freq / TargetI2cBaudRate);

    if ((Freq / I2cDiv) > I3C_IP_MAX_I2C_BAUD_RATE)
    {
        I2cDiv++;
    }

    /* Compute I2CBAUD count for determined div, yet not the final I2CBAUD count */
    TempI2cBaudCount = (I2cDiv - 1U) << 1U;
...
/*FUNCTION**********************************************************************
*
* Function Name : I3c_Ip_MasterBlockingConfigFifo
* Description   : Used to pre-fill FIFO if target address is not the broadcast address.
*                 It is used in Blocking write transfer.
*
* END**************************************************************************/
static void I3c_Ip_MasterBlockingConfigFifo(const uint8 Instance)
{
                                                          ...
                                                          I3c_Ip_MasterStateType * const Master)
{
    ...
    else
    {
        ...
        if (Master->TransferOption.SendStop == TRUE)
        {
            /* Wait for control done flag */
            ReturnStatus = I3c_Ip_MasterWaitForStatus(Base, (uint32)I3C_MSTATUS_MCTRLDONE_MASK);
        }
                       ...
                       const I3c_Ip_MasterConfigType * const Config)
{
...
#if (STD_ON == I3C_IP_DMA_FEATURE_AVAILABLE)
    /* Set the initial DMA configuration of the I3C master */
    if (I3c_Ip_apxMasterState[Instance]->TransferType == I3C_IP_USING_DMA)
    {
        I3c_Ip_DmaMasterInit();
    }
#endif /* I3C_IP_DMA_FEATURE_AVAILABLE */
    ...
    /* Enable the master module in the configured mode */
...
#if (STD_ON == I3C_IP_DMA_FEATURE_AVAILABLE)
    /* Set the initial DMA configuration of the I3C master */
    if (I3c_Ip_apxSlaveState[Instance]->TransferType == I3C_IP_USING_DMA)
    {
        I3c_Ip_DmaSlaveInit();
    }
#endif /* I3C_IP_DMA_FEATURE_AVAILABLE */
                                            ...
                                            const I3c_Ip_TransferConfigType * const TransferOption)
{
        ...
        (MasterState == (uint8)I3C_IP_MASTER_MODE_SLAVE_REQUEST))
    {
        ...
        I3c_Ip_MasterBlockingConfigFifo(Instance);
        ...
        /* After address phase, master status will be I3C_IP_STATUS_SUCCESS if no timeout or error occured */
        if (ReturnStatus == I3C_IP_STATUS_SUCCESS)
        {
        ...
        if (Master->Status == I3C_IP_STATUS_ERROR)
        {
        ...
        (MasterState == (uint8)I3C_IP_MASTER_MODE_SLAVE_REQUEST))
    {
...
#endif /* I3C_IP_DMA_FEATURE_AVAILABLE */
        {
            ...
            if (Master->TransferOption.SlaveAddress != I3C_IP_BROADCAST_ADDRESS)
            {
                ...
                /* Write Master Tx FIFO with data. If more data to transfer, Tx interrupt is used. */
                I3c_Ip_MasterSendMessage(Base, Master);
                                                 ...
                                                 uint32 * const BytesRemaining)
{
    ...
    {
#if (STD_ON == I3C_IP_DMA_FEATURE_AVAILABLE)
        if ((Master->TransferType == I3C_IP_USING_DMA) && (Master->BufferSize != 0U))
        {
            if (Master->TransferOption.Direction == I3C_IP_WRITE)
            {
            ...
            Dma_Ip_GetLogicChannelParam(I3cDmaChn, DMA_IP_CH_GET_CURRENT_ITER_COUNT, BytesRemaining);
            if (Master->TransferOption.TransferSize == I3C_IP_TRANSFER_HALF_WORDS)
            {
                                                ...
                                                uint32 * const BytesRemaining)
{
    ...
    {
#if (STD_ON == I3C_IP_DMA_FEATURE_AVAILABLE)
        if ((Slave->TransferType == I3C_IP_USING_DMA) && (Slave->BufferSize != 0U))
        {
                               ...
                               const boolean Enable)
{
    ...
    I3c_Ip_SlaveSetMapAddressFields(Base, AddressType, Address, Nack, Enable);
...
void I3c_Ip_IRQHandler(const uint8 Instance)
{
    ...
    if (I3c_Ip_apxMasterState[Instance] != NULL_PTR)
    {
        MasterDevice = TRUE;
    ...
    /* If the module is initialized and the interrupt was spurious
       clear the corresponding interrupt status flags */
    if (Spurious == TRUE)
    {
        if (MasterDevice == TRUE)
        {
            /* Clear master status flags */
            I3c_Ip_MasterClearAllStatusFlags(Base);
        }
        else if (SlaveDevice == TRUE)
        {
            /* Clear slave status flags */
            I3c_Ip_SlaveClearAllStatusFlags(Base);
        }
        else
        {
...
/*FUNCTION**********************************************************************
*
* Function Name : I3c_Ip_SlaveTxDmaCompleteTransfer
* Description   : Finish sending data using dma and send the last data using interrupt.
*
* END**************************************************************************/
void I3c_Ip_SlaveTxDmaCompleteTransfer(const uint8 Instance)
{
    ...
    if (Slave->TransferSize == I3C_IP_TRANSFER_HALF_WORDS)
    {
        Slave->DataBuffer = &(Slave->DataBuffer[(Slave->BufferSize - 2U)]);
        Slave->BufferSize = 2U;
    }
    else
    {
        Slave->DataBuffer = &(Slave->DataBuffer[(Slave->BufferSize - 1U)]);
        Slave->BufferSize = 1U;
    }

    /* Enable Tx interrupt to send the last data */
    I3c_Ip_SlaveEnableInterrupts(Base, (uint32)I3C_SINTSET_TXSEND_MASK);
}
#endif /* I3C_IP_DMA_FEATURE_AVAILABLE */
...
#if (STD_ON == I3C_IP_DEV_ERROR_DETECT)
        DevAssert(PpBaudCount <= I3C_IP_MAX_PPBAUD);
        DevAssert(I2cBaudCount <= I3C_IP_MAX_I2CBAUD);
#endif
        /* Enter critical section */
