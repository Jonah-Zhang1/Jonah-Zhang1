...
/* Checks against Flexio_Uart_Ip_HwAccess.h */
...
/*FUNCTION**********************************************************************
 *
 * Function Name : Flexio_Uart_Ip_OperationHandler
                                            ...
                                            const uint8 TimerMaskFlag)
{
    ...
    if (0U == UartState->RemainingBytes)
    {
        ...
        {
            /*In case the Interrupt is spurious and the ISR shall only clear the interrupt status flag and return immediately*/
 ...
 * Implements : Flexio_Uart_Ip_AsyncSendData_Activity
 *
 *END**************************************************************************/
 ...
 * Implements : Flexio_Uart_Ip_SyncSendData_Activity
 *
 *END**************************************************************************/
