...
#define PLATFORM_CFG_SW_MAJOR_VERSION              2
...
#define IntmChannel_0                     (PlatformConf_PlatformIntmChannel_IntmChannel_0)

#define PlatformConf_PlatformIntmChannel_IntmChannel_0  ((uint8)0U) 
