...
#define ETH_CFG_SW_MAJOR_VERSION             2
#define ETH_CFG_SW_MINOR_VERSION             0
#define ETH_CFG_SW_PATCH_VERSION             0
...
#define ETH_MAX_COREIDX_SUPPORTED       (uint32)(1U)  
...
#define ETH_GET_COUNTER_API             (STD_ON)
