...
#define ETH_PBCFG_SW_MAJOR_VERSION_C              2
#define ETH_PBCFG_SW_MINOR_VERSION_C              0
#define ETH_PBCFG_SW_PATCH_VERSION_C              0
...
/* Checks against Eth_Ipw_Cfg.h */
    ...
    #if ((ETH_PBCFG_AR_RELEASE_MAJOR_VERSION_C != DEM_INTERRID_AR_RELEASE_MAJOR_VERSION) || \
         (ETH_PBCFG_AR_RELEASE_MINOR_VERSION_C != DEM_INTERRID_AR_RELEASE_MINOR_VERSION))
        #error "AUTOSAR Version Numbers of Eth_PBcfg.c and Dem_IntErrId.h are different"
    #endif
  #endif
...
static const Eth_EgressCfgType Eth_aEgressConfigPB[1U] =
{
    ...
    /* The configuration structure for Eth_aEgressConfigPB[0U] - IP_0 */
    {
...
static const Eth_IngressCfgType Eth_aIngressConfigPB[1U] =
{
    ...
    /* The configuration structure for Eth_aIngressConfigPB[0U] - IP_0 */
    {
...
static const Eth_ClockCfgType Eth_aClockConfigPB[1U] =
{
    ...
    /* The configuration structure for Eth_aClockConfigPB[0U] - IP_0 */
    {
...
static const Eth_CtrlCfgType Eth_aCtrlConfigPB[1U] =
{
    ...
    /* The configuration structure for Eth_aCtrlConfigPB[0U] - IP_0 */
    {
