...
#define PLATFORM_IPW_CFG_SW_MAJOR_VERSION_C              2
...
*/
static const uint8 Platform_ChIndexMap[1U] = 
{
    0U  
};
...
static const Platform_IntmChannelConfigType aIntmChannelConfig[] = { 
    { INTM_IP_MONITOR0, INT0_IRQn, 0 }, 
};
...
const Platform_Ipw_ConfigType ipwConfig = {
    ...
    &IntmConfig   /* Interrupt monitor settings */
};
